...
const AntDesignThemePlugin = require("./webpack-plugins");
...
function dynamicAntdTheme(options) {
  return function(config) {
    return updateConfig(config, process.env.NODE_ENV, options);
  };
}

module.exports = dynamicAntdTheme;
